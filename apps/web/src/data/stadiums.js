// ─── World Cup 2026 Stadiums (mirrored from backend) ─────────────────────────
...
// Group stadiums by country for the UI
export const STADIUM_GROUPS = [
  { country: 'USA', emoji: '🇺🇸', stadiums: STADIUMS.filter((s) => s.country === 'USA') },
  { country: 'Mexico', emoji: '🇲🇽', stadiums: STADIUMS.filter((s) => s.country === 'Mexico') },
  { country: 'Canada', emoji: '🇨🇦', stadiums: STADIUMS.filter((s) => s.country === 'Canada') },
];
